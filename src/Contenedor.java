...
public class Contenedor {
	...
	public static void almacenarProfesional(Contenedor contenedora) {
		...
		}while (input.trim().isEmpty() ||(input.length() >= 10 & input.length() <= 50) );
	...
	public static void almacenarCapacitacion(int idCapacitacion, Contenedor contenedora) { // Ojo cambiar por int Run
		...
		System.out.println("Ingrese la Hora de la capacitación : debe ser una hora válida del día, en formato HH:MM (hora desde 0 a23, minutos entre 0 y 59)");
		input = sc.nextLine();
